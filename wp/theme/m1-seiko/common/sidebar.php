<div class="l-sidebar">
  <p class="l-sidebar_sp_open u-pc-hide"><i class="fa fa-list-ul"></i>製品メニュー</p>
  <div class="l-sidebar_inner">
    <div class="u-sp-hide">
      <h3>PRODUCTS MENU<span>製品メニュー</span></h3>
    </div>
...
<?php wp_reset_query(); ?>
  ...
  <h3 class="blog-menu"><a href="/craftsmanship/"><img src="<?php echo get_template_directory_uri(); ?>/images/common/header_blog.png" srcset="<?php echo get_template_directory_uri(); ?>/images/common/header_blog.png 1x, <?php echo get_template_directory_uri(); ?>/images/common/header_blog@2x.png 2x" alt="M1のものづくり当社の取り組み"></a></h3>
