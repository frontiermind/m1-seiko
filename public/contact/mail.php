...
$thanksPage = "https://www.dias-k.com/contact/thanks.html";
...
$require = array("お名前","フリガナ","電話番号","メールアドレス","内容");
...
$re_subject = "株式会社Dias | お問い合わせありがとうございました。";
...
尚、3日経ってもご連絡がない場合はお手数ですが、一度お電話頂くようお願い申し上げます。
...
株式会社ディアス
〒103-0013
東京都中央区日本橋人形町2-1-9 日本橋Tビル8F
TEL：03-5623-4410
FAX：03-5623-4412
https://www.dias-k.com
──────────────────────
...
<head>
  ...
  <meta name="keywords" content="ディアス,商業施設,店舗,デザイン,設計,施工,アミューズメント">
  <meta name="description" content="ディアスでは、商業施設・店舗・アミューズメント施設の設計・デザイン・施工を行っています。お客様のこだわりを大切にし、オリジナリティの高いご提案を行います。">
  <title>株式会社ディアス | 商業施設や店舗などのプラン・施工</title>

  <link rel="alternate" hreflang="ja" href="https://www.dias-k.com/contact/">
  <link rel="canonical" href="https://www.dias-k.com/contact/">



    <!-- ogp -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://www.dias-k.com/contact/">
    <meta property="og:description" content="ディアスでは、商業施設・店舗・アミューズメント施設の設計・デザイン・施工を行っています。お客様のこだわりを大切にし、オリジナリティの高いご提案を行います。">
    <meta property="og:image" content="https://www.dias-k.com/images/common/ogimage.png">
    <meta property="og:title" content="株式会社ディアス | 商業施設や店舗などのプラン・施工">
    <meta property="og:site_name" content="高輪精機">
    <!-- /ogp -->
...
<body class="contact l-page">
	<div class="l-wrapper">

    <header id="header" class="l-header">

      <div class="header-top">
        <p class="top-text">株式会社ディアスは商業施設や店舗などのプラン・施工を行っております。</p>
        <h1 class="header-logo">
          <a href="/"><img src="/images/common/logo.png" srcset="/images/common/logo.png 1x, /images/common/logo@2x.png 2x" alt="株式会社ディアス"></a>
        </h1>
        <div class="g-nav-block">
        <nav id="js-menu" class="globalnavi">
           <ul class="gnavi-list">
            <li class="gnav_index"><a href="/">HOME<span>トップページ</span></a></li>
            <li class="gnav_business"><a href="/business/">BUSINESS<span>事業内容</span></a></li>
            <li class="gnav_flow"><a href="/flow/">WORK FLOW<span>ご依頼の流れ</span></a></li>
            <li class="gnav_gallary"><a href="/gallary/">GALLARY<span>ギャラリー</span></a></li>
            <li class="gnav_company"><a href="/company/">COMPANY<span>会社案内</span></a></li>
          </ul>
        </nav>
        </div>
        ...
        <a href="/contact/" class="header-contact btn btn-contact"><i class="fas fa-envelope"></i><span>お問い合わせ</span></a>
      </div>
        ...
        <section class="page-block">
          ...
          <div class="page-block--contents">
            <div class="l-container">
              ...
              <section class="sec-content pege-first_txt" >
                <div class="l-container">

                  <div class="contact_box">
                <?php if($empty_flag == 1){ ?>
                 <p class="u-ta-c u-mb-20">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p>
                  <?php echo $errm; ?><br /><div class="p-contact__btn"><button class="form-reset u-mt-30 u-mb-30 btn .btn-submit" type="button" value=" 前画面に戻る " onclick="history.back()">前画面に戻る</button></div>
                  <?php }else{ ?>
...
<section class="sec-contact footer-contact">
...
<footer id="footer" class="l-footer">
  <div class="l-container">
    <ul class="footer-menu">
      <li class="footer-menu_top">
        <div class="footer-menu_top_box">
          <a href="/"><img src="/images/common/logo.png" srcset="/images/common/logo.png 1x, /images/common/logo@2x.png 2x" alt="株式会社ディアス"></a>
          <div class="footer-access">
          <p>株式会社ディアス<br>
            東京都中央区日本橋小伝馬町12-5 小伝馬町YSビル9F<br>
            TEL : 03-5623-4410</p>
          </div>
        </div>
      </li>
  ...
  <!--<p class="footer-copy"><small>Copyright (C) 株式会社ディアス. All rights reserved.</small></p>-->
